local bg = "#15130c"
local fg = "#e7e2d5"
local fg_variant = "#ccc6b5"
local accent = "#d5c871"
local accent_fg = "#373100"
local secondary = "#cfc7a2"
local secondary_container = "#4c472b"
local on_secondary_container = "#ebe3bd"
local tertiary = "#a7d0b7"
local error = "#ffb4ab"
local on_error = "#690005"
local outline = "#959181"
local outline_variant = "#4a4739"
local surface_container = "#212017"
local surface_variant = "#4a4739"
